    ...
    render() {
        ...
        return (
            <div style={{height:'100%',display:'flex',flexDirection:'column'}}>
                ...
                icon={<Icon key={0} type="left" size="md" color='black'/>}
                rightContent={
                ...
                <div style={{flex:'1',overflow:'auto',marginBottom:'4.5rem'}}>
                    <div style={{width:'100%',height:"auto",display:'flex',flexDirection:'column',padding:'1rem 0',backgroundImage:'url('+infos.creator.backgroundUrl+')',backgroundSize:'100% 100%'}}>
                        <div style={{width:'100%',display:'flex',justifyContent:'space-around',alignItems:'center',marginBottom:'1rem'}}>
                            ...
                            <div style={{width:"60%"}}>
                                <p style={{fontSize:'1rem',color:'#fff',marginBottom:'1rem'}}>{infos.name}</p>
                                <div style={{width:"100%" ,display:'flex',justifyContent:'space-between',alignItems:'center'}}>
                                    <img src={infos.creator.avatarUrl} style={{width:'20%',borderRadius:'50%'}}/>
                                    <p style={{color:'#fff',width:'60%'}}>{infos.creator.nickname}</p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    return (
                                        ...
                                        onClick={()=>{
                                            ...
                                            <div style={{width:'70%',height:'100%',display:'flex',flexDirection:"column",justifyContent:'space-around',fontSize:'1rem'}}>
                                                <p style={{height:'1rem',lineHeight:'1rem',width:'100%',overflow:'hidden',textOverflow:"ellipsis",whiteSpace:'nowrap' }}>{item.name}</p>
                                                <p style={{height:'1rem',lineHeight:'1rem',width:'100%'}} className='shenglh'>{item.ar[0].name}</p>
                                            </div>
                                            <div style={{width:'30%',height:'100%',display:'flex',justifyContent:'space-around',fontSize:'1rem'}}>
